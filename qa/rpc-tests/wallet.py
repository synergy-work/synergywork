...
#   c) node1 mines 32 blocks, so now node 0 has 60001swk, node 1 has 4250swk, node2 has none.
#   d) node0 sends 601 swk to node2, in two transactions (301 swk, then 300 swk).

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SynergyWork Core synergywork-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  synergywork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded synergywork transaction") + "\n" +
                               "  synergywork-tx [options] -create [commands]   " + _("Create hex-encoded synergywork transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded synergywork transaction

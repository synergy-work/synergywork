...
/* SynergyWork GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SYNERGYWORK"
#define QAPP_ORG_DOMAIN "synergy-work.com"
#define QAPP_APP_NAME_DEFAULT "SYNERGYWORK-Qt"
#define QAPP_APP_NAME_TESTNET "SYNERGYWORK-Qt-testnet"

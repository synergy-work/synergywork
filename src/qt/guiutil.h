...
/** Utility functions used by the SYNERGYWORK Qt UI.
 */
namespace GUIUtil
{
...
// Render SYNERGYWORK addresses in monospace font
...
// Parse "synergywork:" URI into recipient object, return true on successful parsing

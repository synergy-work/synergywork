...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SYNERGYWORK Core"),
     ...
     * override -datadir in the synergywork.conf file in the default data directory
     * (to be consistent with synergyworkd behavior)
     */
    if (dataDir != getDefaultDataDirectory())

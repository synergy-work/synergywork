                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSWKPathCustom = GetArg("-zswkbackuppath", "");
    ...
    if(!strzSWKPathCustom.empty()) {
        ui->wallet_customzswkbackuppath->setText(QString::fromStdString(strzSWKPathCustom));
        ui->wallet_customzswkbackuppath_label->setVisible(true);
        ui->wallet_customzswkbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSWKPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SYNERGYWORK RPC console.") + "<br>" +

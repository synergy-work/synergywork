...
/**
 * SYNERGYWORK RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzswkseed(const UniValue& params, bool fHelp);
extern UniValue getzswkseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzswk(const UniValue& params, bool fHelp);
extern UniValue dzswkstate(const UniValue& params, bool fHelp);

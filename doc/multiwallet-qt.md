...
In order to support loading of multiple wallets in synergywork-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is synergywork.cpp.
...
Changes to synergywork.cpp
----------------------
synergywork.cpp is the entry point into synergywork-qt, and as such, will require some minor modifications to provide hooks for

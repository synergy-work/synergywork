Contributing to SYNERGYWORK Core
============================

The SYNERGYWORK Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SYNERGYWORK Core project, and is not to be
confused with overall SYNERGYWORK Network Protocol consensus changes.

Whether a pull request is merged into SYNERGYWORK Core rests with the project merge
...
Patches that change SYNERGYWORK consensus rules are considerably more involved than
...
Where a patch set proposes to change the SYNERGYWORK consensus, it must have been
...
The project leader is the release manager for each SYNERGYWORK Core release.
